package ru.rcfh.feature.home.presentation.component
...
import ru.rcfh.feature.home.R
import ru.rcfh.feature.home.presentation.HomeUiState

enum class DrawerDestination(
    @StringRes val label: Int,
    val imageVector: ImageVector,
) {
    DOCUMENTS(label = R.string.label_documents, imageVector = AppIcons.Document),
    SETTINGS(label = R.string.label_settings, imageVector = AppIcons.Settings)
}

@Composable
internal fun HomeNavigationDrawerContent(
    uiState: HomeUiState,
